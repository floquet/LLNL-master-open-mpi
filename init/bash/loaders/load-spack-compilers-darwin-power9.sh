...
l_compilers="${l_compilers} gcc@5.5.0  gcc@5.4.0"
l_compilers="${l_compilers} gcc@4.8.5"
## XL
l_compilers="${l_compilers} xl@13.1.7    xl@13.1.6"
l_compilers="${l_compilers} xl_r@13.1.7  xl_r@13.1.6"
## pgi
l_compilers="${l_compilers} pgi@18.3  pgi@17.10  pgi@17.5  pgi@16.10"

census=( ${l_compilers} )
echo "${#census[@]} Spack-recognized compilers loaded"

# dantopa@cn2021:spack.current.darwin.power9 $ date
# Mon May  7 17:03:06 MDT 2018

# dantopa@cn2021:spack.current.darwin.power9 $ pwd
# /tmp/dantopa/amarillo/spack.current.darwin.power9

# dantopa@cn2021:spack.current.darwin.power9 $ spack arch
# linux-rhel7-ppc64le

# dantopa@cn2021:spack.current.darwin.power9 $ spack compilers
# ==> Available compilers
